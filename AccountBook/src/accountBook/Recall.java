...
public class Recall extends JFrame implements ActionListener{
	...
	public Recall(String id){
		...
		calculator = new JButton("´õÄ¡ÆäÀÌ°è»ê±â");
		...
		//Á¦¸ñ
		JLabel collect = new JLabel("È°µ¿ºñ È¸¼ö³»¿ª");
		collect.setFont(new Font("³ª´®°íµñ", Font.PLAIN, 40));
		collect.setBounds(12, 10, 338, 69);
		info.add(collect);
		
		//»èÁ¦ ¹× Ãß°¡ ¹öÆ°
		add = new JButton("Ãß°¡");
		add.setFont(new Font("³ª´®°íµñ", Font.PLAIN, 15));

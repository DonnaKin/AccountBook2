...
public class Recall_Input{
	...
	public Recall_Input(String id){
		  JFrame jf_input = new JFrame("ÀÔ·Â");
	      ...
	      for(int k =-5; k<2;k++){YearCh.add(String.valueOf(2017+k));}
			...
			DayCh.setFont(new Font("³ª´®°íµñ", Font.PLAIN, 15));

...
//		menubar.add(pounder);
		...
		//infomation
		  ...
		  info.setFont(new Font("나눔고딕", Font.PLAIN, 53));
		  info.setBounds(53, 7, 405, 81);
		  panel.add(info);
		...
		label.setFont(new Font("나눔고딕", Font.PLAIN, 30));
		label.setBounds(63, 80, 214, 57);
		gragh.add(label);
		text = new JTextField(10);
		text.setBounds(392, 89, 204, 39);
		gragh.add(text);
		JLabel label2 = new JLabel("명수");
		label2.setFont(new Font("나눔고딕", Font.PLAIN, 30));
		label2.setBounds(63, 200, 214, 39);
		gragh.add(label2);
		text2 = new JTextField(10);
		text2.setBounds(392, 200, 204, 39);
		gragh.add(text2);
		dutch = new JButton("더치페이");
		dutch.setFont(new Font("나눔고딕", Font.PLAIN, 25));
		dutch.setBounds(266, 350, 133, 50);
